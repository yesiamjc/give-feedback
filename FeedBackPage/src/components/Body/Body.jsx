  ...
  return (
    <div className='bodyCont'>
      <form onSubmit={handleSubmit} className="bodyForm">
        <label className="ls F">Name:</label>
        <input
          type="text"
          name="name"
          id=""
          ...
          required
        />
        <label className="ls F">Email:</label>
        <input
          type="email"
          name="email"
          id=""
          ...
          required
        />
        <label className="ls F">How satisfied are you with our products ?</label>
        <input
          type="number"
          name="input1"
          id=""
          ...
          required
        />
        <label className="ls F">How often would you recommend this to others ?</label>
        <input
          type="number"
          name="input2"
          id=""
          ...
          required
        />
        <label className="ls F">How would you rate staff behavior ?</label>
        <input
          type="number"
          name="input3"
          id=""
          ...
          required
        />
        <label className="ls F">How would you rate after-sales service ?</label>
        <input
          type="number"
          name="input4"
          id=""
